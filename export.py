...
def welfare_export():
    ...
    for v in villagers:
        ...
        # 基础福利
        basic_welfare = calculate_basic_welfare(v)
        basic_data.append({
            '公民身份证号码': v.id_card,
            '姓名': v.name,
            '年份': config.year,
        ...
        # 养老金
        elderly_welfare = calculate_elderly_welfare(v)
        ...
        # 计算合计福利金额
        total_welfare = basic_welfare['amount'] + elderly_welfare['amount'] + university_total + highschool_total
